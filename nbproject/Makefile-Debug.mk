...
${OBJECTDIR}/Device.o: Device.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Device.o Device.cpp

${OBJECTDIR}/BluezBluetooth.o: BluezBluetooth.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/BluezBluetooth.o BluezBluetooth.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/BluezBluetoothTest.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} ../../gtest/libgtest.a -lpthread 


${TESTDIR}/tests/BluezBluetoothTest.o: tests/BluezBluetoothTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. -I. -I../../gtest/gtest_src/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/BluezBluetoothTest.o tests/BluezBluetoothTest.cpp
...
${OBJECTDIR}/Device_nomain.o: ${OBJECTDIR}/Device.o Device.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -fPIC  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Device_nomain.o Device.cpp;\
	else  \
...
${OBJECTDIR}/BluezBluetooth_nomain.o: ${OBJECTDIR}/BluezBluetooth.o BluezBluetooth.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -fPIC  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/BluezBluetooth_nomain.o BluezBluetooth.cpp;\
	else  \
